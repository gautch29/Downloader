...
export function SeriesSearchClient() {
    const { t } = useI18n();
    const [query, setQuery] = useState('');
    const [series, setSeries] = useState<GroupedMovie[]>([]);
        ...
        <div className="container mx-auto p-4 md:p-6 max-w-7xl space-y-6 md:space-y-8">
            ...
            <div className="text-center space-y-2 md:space-y-4 animate-fade-in-up pt-4 md:pt-0">
                <div className="flex items-center justify-center gap-2 md:gap-3">
                    <Tv className="h-6 w-6 md:h-8 md:w-8 text-[#0071E3] dark:text-[#0A84FF]" />
            ...
            {/* Results */}
            {searched && !loading && !error && series.length > 0 && (
