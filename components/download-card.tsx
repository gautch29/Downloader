...
export function DownloadCard({ download }: DownloadCardProps) {
    ...
    return (
        <div className="group relative overflow-hidden rounded-xl border border-white/40 bg-white/60 p-4 transition-all hover:border-white/60 hover:bg-white/80 shadow-sm hover:shadow-md">
            ...
            <div className="relative z-10 flex items-center justify-between gap-4">
                ...
                ${isDownloading ? 'bg-violet-500/10 text-violet-600 animate-pulse' : ''}
            ...
            {isDownloading && (
                <div className="absolute bottom-0 left-0 h-[2px] w-full bg-zinc-200">
                    <div
